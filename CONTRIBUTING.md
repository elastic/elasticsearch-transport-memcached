...
**Repository:** [https://github.com/elasticsearch/elasticsearch-transport-memcached](https://github.com/elasticsearch/elasticsearch-transport-memcached)
...
```sh
cd elasticsearch-transport-memcached/
