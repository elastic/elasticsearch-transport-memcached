...
```sh
bin/plugin install elasticsearch/elasticsearch-transport-memcached/2.5.0
```
...
| es-1.6        |  Build from source    | [2.6.0-SNAPSHOT](https://github.com/elasticsearch/elasticsearch-transport-memcached/tree/es-1.6/#version-260-snapshot-for-elasticsearch-16)  |
